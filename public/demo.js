...
$(document).ready(function() {
   ...
   $cy.cytoscape({
    ...
    if (file) {
        ...
        // 修改所有 AJAX 请求，将本地服务器地址改为相对路径
        $("#testexploit").click(function(){
            const Http = new XMLHttpRequest();
            const url = '/api/refntestexploit';  // 改为相对路径
            Http.open("GET", url);
            Http.send();
        ...
        $("#showprotospec").click(function(){
            console.log("Show protocol spec - Backend not implemented in demo");
            document.getElementById('contents').textContent = "Protocol specification display - Backend functionality would be implemented here";
        });

        $("#updatemodel").click(function(){
            console.log("Update model - Backend not implemented in demo");
            document.getElementById('contents').textContent = "Model update functionality - Backend functionality would be implemented here";
        });

        $("#modeltorule").click(function(){
            console.log("Model to rule - Backend not implemented in demo");
            document.getElementById('contents').textContent = "Model to rule conversion - Backend functionality would be implemented here";
        });

        $("#autopatchtest").click(function(){
            console.log("Auto patch test - Backend not implemented in demo");
            document.getElementById('contents').textContent = "Auto patch testing - Backend functionality would be implemented here";
        });

        $("#selectexploit").click(function(){
            console.log("Select exploit - Backend not implemented in demo");
            document.getElementById('contents').textContent = "Exploit selection - Backend functionality would be implemented here";
        });

        $("#showprotoparserhttp").click(function(){
            console.log("Show protocol parser HTTP - Backend not implemented in demo");
            document.getElementById('contents').textContent = "HTTP protocol parser display - Backend functionality would be implemented here";
        });

        $("#updatemodelhttp").click(function(){
            console.log("Update model HTTP - Backend not implemented in demo");
            document.getElementById('contents').textContent = "HTTP model update - Backend functionality would be implemented here";
        });

        $("#modeltorulehttp").click(function(){
            console.log("Model to rule HTTP - Backend not implemented in demo");
            document.getElementById('contents').textContent = "HTTP model to rule conversion - Backend functionality would be implemented here";
        });

        $("#autopatchtesthttp").click(function(){
            console.log("Auto patch test HTTP - Backend not implemented in demo");
            document.getElementById('contents').textContent = "HTTP auto patch testing - Backend functionality would be implemented here";
        });
